 ...
 * NOTE: THESE TESTER ISN'T COMPLETE, TESTER WILL BE FULLY FINISHED AFTER COURSE INSTRUCTORS WILL GIVE NEW FURTHER INSTRUCTIONS !!
...
public class AirportTester {
    ...
    public void firstFlightFromOriginMethod(){
        // firstFlightFromOrigin Method checks the first flight to departure from the origin given as a parameter sent to method itself, only inside the specific Airport (Array)
